...
<div class="form first row g-3" id="form1">
    <div class="col-md-4">
      ...
      <input type="text" class="form-control" id="inputname" name="father" value="<?= $row['student_father'];?>" required>
      <div class="validation-message"></div>
    </div>
    <div class="col-md-4">
      <label for="inputadno" class="form-label">Mother Name</label>
      <input type="text" class="form-control" id="inputadno" name="mother" value="<?= $row['student_mother'];?>">
    
    </div>
    <div class="col-md-4">
            <label for="inputreg" class="form-label">Parent Phone</label >
            <input type="number" class="form-control" id="inputreg" name="phone" value="<?= $row['parent_phn'];?>">
          </div>

    <div class="col-md-4">
            <label for="inputreg" class="form-label">Parent Address</label >
            <input type="text" class="form-control" id="inputreg" name="adress" value="<?= $row['parent_adres'];?>">
          </div>

    <div class="col-md-4">
        <label for="inputreg" class="form-label">Father State</label>
        <input type="textr" class="form-control" id="inputreg" name="fstate" value="<?= $row['father_state'];?>">
      </div>

        <div class="col-md-4">
            <label for="inputdate" class="form-label">Mother State</label>
            <input type="text" class="form-control" id="inputdate" name="mstate" value="<?= $row['mother_state'];?>">
          </div>
